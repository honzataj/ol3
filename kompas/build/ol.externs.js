 ...
 * @param {number=} opt_minDeltaLambda
 ...
 * @return {Array.<number>}
 */
ol.geom.Circle.prototype.getFlatCoordinates = function() {};
 ...
 * @return {Array.<number>}
 */
ol.geom.LinearRing.prototype.getFlatCoordinates = function() {};
 ...
 * @return {Array.<number>}
 */
ol.geom.LineString.prototype.getFlatCoordinates = function() {};
 ...
 * @return {Array.<number>}
 */
ol.geom.MultiLineString.prototype.getFlatCoordinates = function() {};
 ...
 * @return {Array.<number>}
 */
ol.geom.MultiPoint.prototype.getFlatCoordinates = function() {};
 ...
 * @return {Array.<number>}
 */
ol.geom.MultiPolygon.prototype.getFlatCoordinates = function() {};
 ...
 * @return {Array.<number>}
 */
ol.geom.Point.prototype.getFlatCoordinates = function() {};
 ...
 * @return {Array.<number>}
 */
ol.geom.Polygon.prototype.getFlatCoordinates = function() {};
 ...
 * @return {number}
 */
ol.source.ImageArcGISRest.prototype.findNearestResolution = function(resolution) {};
 ...
 * @return {ol.ImageBase}
 */
ol.source.ImageArcGISRest.prototype.getImage = function(extent, resolution, pixelRatio, projection) {};
 ...
 * @return {number}
 */
ol.source.ImageCanvas.prototype.findNearestResolution = function(resolution) {};
 ...
 * @return {number}
 */
ol.source.ImageMapGuide.prototype.findNearestResolution = function(resolution) {};
 ...
 * @return {ol.ImageBase}
 */
ol.source.ImageMapGuide.prototype.getImage = function(extent, resolution, pixelRatio, projection) {};
 ...
 * @return {number}
 */
ol.source.ImageStatic.prototype.findNearestResolution = function(resolution) {};
 ...
 * @return {number}
 */
ol.source.ImageVector.prototype.findNearestResolution = function(resolution) {};
 ...
 * @return {ol.ImageBase}
 */
ol.source.ImageVector.prototype.getImage = function(extent, resolution, pixelRatio, projection) {};
 ...
 * @return {number}
 */
ol.source.ImageWMS.prototype.findNearestResolution = function(resolution) {};
 ...
 * @return {number}
 */
ol.source.Raster.prototype.findNearestResolution = function(resolution) {};
...
/**
 * @typedef {{tracking: (boolean|undefined), trackingOptions: (GeolocationPositionOptions|undefined), projection: (ol.ProjectionLike)}}
 */
...
/**
 * @typedef {{dataProjection: (ol.ProjectionLike), featureProjection: (ol.ProjectionLike), rightHanded: (boolean|undefined), decimals: (number|undefined)}}
 */
...
/**
 * @typedef {{condition: (ol.EventsConditionType|undefined), kinetic: (ol.Kinetic|undefined)}}
 */
olx.interaction.DragPanOptions;


/**
 * @typedef {{condition: (ol.EventsConditionType|undefined), duration: (number|undefined)}}
 */
...
/**
 * @typedef {{className: (string|undefined), condition: (ol.EventsConditionType|undefined), duration: (number|undefined), out: (boolean|undefined)}}
 */
...
/**
 * @typedef {{condition: (ol.EventsConditionType|undefined), duration: (number|undefined), pixelDelta: (number|undefined)}}
 */
olx.interaction.KeyboardPanOptions;


/**
 * @typedef {{duration: (number|undefined), condition: (ol.EventsConditionType|undefined), delta: (number|undefined)}}
 */
...
/**
 * @typedef {{attributions: (ol.AttributionLike|undefined), compareFn: (ol.source.Cluster.CompareFunction|undefined), distance: (number|undefined), extent: (ol.Extent|undefined), geometryFunction: (undefined|Function), format: (ol.format.Feature|undefined), logo: (string|undefined), projection: (ol.ProjectionLike), source: (ol.source.Vector), wrapX: (boolean|undefined)}}
 */
...
/**
 * @typedef {{url: (string|undefined), displayDpi: (number|undefined), metersPerUnit: (number|undefined), hidpi: (boolean|undefined), useOverlay: (boolean|undefined), projection: (ol.ProjectionLike), ratio: (number|undefined), resolutions: (Array.<number>|undefined), imageLoadFunction: (ol.ImageLoadFunctionType|undefined), params: (Object|undefined)}}
 */
...
/**
 * @typedef {{projection: (ol.ProjectionLike), tileGrid: (ol.tilegrid.TileGrid|undefined), wrapX: (boolean|undefined)}}
 */
...
/**
 * @typedef {{attributions: (ol.AttributionLike|undefined), canvasFunction: (ol.CanvasFunctionType), logo: (string|olx.LogoOptions|undefined), projection: (ol.ProjectionLike), ratio: (number|undefined), resolutions: (Array.<number>|undefined), state: (ol.source.State|undefined)}}
 */
olx.source.ImageCanvasOptions;


/**
 * @typedef {{attributions: (ol.AttributionLike|undefined), logo: (string|olx.LogoOptions|undefined), projection: (ol.ProjectionLike), ratio: (number|undefined), renderBuffer: (number|undefined), resolutions: (Array.<number>|undefined), source: (ol.source.Vector), style: (ol.style.Style|Array.<ol.style.Style>|ol.StyleFunction|undefined)}}
 */
...
/**
 * @typedef {{attributions: (ol.AttributionLike|undefined), crossOrigin: (null|string|undefined), imageExtent: (ol.Extent), imageLoadFunction: (ol.ImageLoadFunctionType|undefined), logo: (string|olx.LogoOptions|undefined), projection: (ol.ProjectionLike), imageSize: (ol.Size|undefined), url: (string)}}
 */
...
/**
 * No `@api` annotation for `ol.StyleImageOptions`, use `Object`.
 * @typedef {Object}
 */
