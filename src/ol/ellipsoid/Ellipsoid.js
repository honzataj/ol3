...
class Ellipsoid {
     ...
     *     Vincenty.  
     */
    vincenty(c1, c2, opt_minDeltaLambda, opt_maxIterations) {
        ...
        var deltaLon = (c2[0] - c1[0]) * Math.PI / 180;
        ...
        for (i = maxIterations; i > 0; --i) {
          ...
          var C = 
              f / 16 * cosSquaredAlpha * (4 + f * (4 - 3 * cosSquaredAlpha));
     ...
     */
    vincentyDistance(c1, c2, opt_minDeltaLambda, opt_maxIterations) {
        var vincenty = 
          this.vincenty(c1, c2, opt_minDeltaLambda, opt_maxIterations);
     ...
     */
    vincentyFinalBearing(c1, c2, opt_minDeltaLambda, opt_maxIterations) {
        var vincenty = 
          this.vincenty(c1, c2, opt_minDeltaLambda, opt_maxIterations);
     ...
     * @return {number} Initial bearing.
     */
    vincentyInitialBearing(c1, c2, opt_minDeltaLambda, opt_maxIterations) {
        var vincenty = 
          this.vincenty(c1, c2, opt_minDeltaLambda, opt_maxIterations);
